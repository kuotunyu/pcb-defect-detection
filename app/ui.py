    ...
    <section class="pcb-section" aria-labelledby="evidence-title">
      <div class="pcb-shell">
        ...
        <div class="pcb-evidence-grid">
          ...
          <article class="pcb-card"><div class="pcb-evidence-heading"><span class="pcb-evidence-number">02</span><h3 translate="no">Paired Evaluation</h3></div><p>首次 Board 08：Grouped 與 leaky-control 共用 final test 與三組 seeds，量化 same-board exposure effect。</p><div class="pcb-evidence-result"><span>{leakage} · mAP50 {grouped}</span><a href="{REPOSITORY_URL}/blob/main/reports/paired_a100/final_metrics.json" target="_blank" rel="noopener noreferrer">原始報告 ↗</a></div><div class="pcb-evidence-result"><a href="{REPOSITORY_URL}/blob/main/reports/lobo/README.md" target="_blank" rel="noopener noreferrer">六板複驗：跨板結果與適用邊界 ↗</a></div></article>
          <article class="{gate_class}"><div class="pcb-evidence-heading"><span class="pcb-evidence-number">03</span><h3 translate="no">Promotion Gate</h3></div><p>{gate_copy}</p><div class="pcb-evidence-result"><span>Strict parity · {parity}</span><a href="{REPOSITORY_URL}/blob/main/reports/backend_parity_l4.json" target="_blank" rel="noopener noreferrer">首次 L4 ↗</a></div><div class="pcb-evidence-result"><a href="{REPOSITORY_URL}/blob/main/reports/l4_rerun_2abe78fe2b54/README.md" target="_blank" rel="noopener noreferrer">修正 reference 幾何後 L4 驗證：rerun 的 overall gate 仍 failed ↗</a></div></article>
        </div>
      </div>
    </section>
    """

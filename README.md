...
|---|---:|---|
| **Common Final Test** | 30 (5/class) | 鎖定 **Board 08**；兩組訓練集均不得包含此 30 張測試影像 |
| **Validation** | 60 (10/class) | 鎖定 **Board 01**；供超參數選擇與模型早停共用 |
...
| **Leaky-control Train (洩漏對照組)** | 513 | 將其中 30 張替換為 Board 08 之兄弟樣本 (Siblings) 進行對照 |
...
|---|---:|---:|---:|---|
| **嚴格分組組 (Grouped)** | **63.30% ± 14.91%** | 38.21% ± 9.80% | 0.6087 | 真實跨板泛化表現，反映實際產線佈署效能 |

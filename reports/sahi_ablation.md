# Legacy SAHI exploration — do not promote

> This analysis used the legacy test board and is not part of the frozen paired protocol. It is
> retained to document why SAHI/hi-resolution expansion is out of scope, not as current evidence.
